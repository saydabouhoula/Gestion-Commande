...
($.fn.AdminSettings = function (t) {
  ...
  $(function () {
    ...
    $("#chat .message-center a").on("click", function () {
      var a,
        e,
        t = $(this).find(".mail-contnet h5").text(),
        i = $(this).find(".user-img img").attr("src"),
        r = $(this).attr("data-user-id"),
        s = $(this).find(".profile-status").attr("data-status");
      $(this).hasClass("active")
        ? ($(this).toggleClass("active"),
          $(".chat-windows #user-chat" + r).hide())
        : ($(this).toggleClass("active"),
          $(".chat-windows #user-chat" + r).length
            ? $(".chat-windows #user-chat" + r)
            ...
            : ((a = msg_receive(
              ...
              (e =
                (e =
                  ...
                  r +
                  "'></i></span></div><div class='chat-body'><ul class='chat-list'>" +
                  (a += msg_sent("That is very deep indeed!")) +
                  "</ul></div>") +
                "<div class='chat-footer'><input type='text' data-user-id='" +
                r +
                "' placeholder='Type & Enter' class='form-control'></div></div>"),
      ...
      $(document).on(
        ...
        function (a) {
          ...
          13 == a.keyCode &&
            ...
            $(".chat-windows #user-chat" + e + " .chat-body .chat-list").append(
              a
            ),
            $(this).val(""),
            $(this).focus()),
